...
export type FriendSubResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes['FriendSub'] = ResolversParentTypes['FriendSub']
> = {
  user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
...
> = {
  addFriend?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddFriendArgs, 'friendId'>
  >;
  addNotificationToken?: Resolver<
    Maybe<ResolversTypes['Notification']>,
    ParentType,
    ContextType,
    RequireFields<MutationAddNotificationTokenArgs, 'notification'>
  >;
  changeEmailPassword?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationChangeEmailPasswordArgs, 'password' | 'newPassword'>
  >;
  ...
  createGallery?: Resolver<
    Maybe<ResolversTypes['Gallery']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateGalleryArgs, 'photoURL'>
  >;
  createMessage?: Resolver<
    Maybe<ResolversTypes['MessagePayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateMessageArgs, 'message' | 'channelId'>
  >;
  deleteChannel?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteChannelArgs, 'channelId'>
  >;
  deleteFriend?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteFriendArgs, 'friendId'>
  >;
  deleteGallery?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteGalleryArgs, 'galleryId'>
  >;
  findPassword?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationFindPasswordArgs, 'email'>
  >;
  removeNotificationToken?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveNotificationTokenArgs, 'token'>
  >;
  sendVerification?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationSendVerificationArgs, 'email'>
  >;
  setOnlineStatus?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationSetOnlineStatusArgs, never>
  >;
  ...
  >;
  signInWithSocialAccount?: Resolver<
    ResolversTypes['AuthPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationSignInWithSocialAccountArgs, 'socialUser'>
  >;
  ...
  updateGallery?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateGalleryArgs, 'galleryId' | 'photoURL'>
  >;
  updateProfile?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateProfileArgs, 'user'>
  >;
};
...
> = {
  ...
  galleries?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGalleriesArgs, 'userId'>
  >;
...
> = {
  friendChanged?: SubscriptionResolver<
    Maybe<ResolversTypes['FriendSub']>,
    'friendChanged',
    ParentType,
    ContextType,
    RequireFields<SubscriptionFriendChangedArgs, 'userId'>
  >;
